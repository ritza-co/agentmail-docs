...
<Frame caption="AgentMail turns unstructured data to structured data for easier agent digestion, serving as a default system of record, and can eventually be used for authentication and orchestration">
