...
<CardGroup>
  <Card title="No API for Inboxes" icon="fa-solid fa-link-slash">
    They lack API support for creating new inboxes on-demand.
  </Card>
...
<Steps>
  <Step title="API-First Infrastructure">
    ...
    <Callout icon="fa-solid fa-unlock">
      **High-Volume Ready**: Avoid restrictive rate or sending limits.
    </Callout>
    ...
    <Callout icon="fa-solid fa-key">
      **Simple Authentication**: Use API keys, not complex OAuth flows.
    </Callout>
  </Step>
